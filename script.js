...
//Solicita al usuario que el ingrese el primer número y lo convierten número punto flotante
...
//Verifica que operación a elegido el usuario y realiza la operación correspondiente
if(operacion == 1){
...
document.write("Los números que ingresaste fueron " + numero1 + " y " + numero2 + " y el resultado de la operación de " + nombre);
